...
+ (PESGraphEdge *)edgeWithName:(NSString *)aName andWeight:(NSNumber *)aNumber andIndicacion:(NSString *)aIndicacion{
    
    PESGraphEdge *anEdge = [[PESGraphEdge alloc] init];
    
    anEdge.weight = aNumber;
    anEdge.name = aName;
    anEdge.indicacion = aIndicacion;
